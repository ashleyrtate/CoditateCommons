...
{
    /// <summary>
    /// A version of <c>System.Web.HttpUtility"</c> for use with the .NET client profile.
    /// </summary>
    /// <remarks>
    /// This is simply a copy of the code from the .NET library with all dependencies on
    /// the System.Web assembly removed. It's necessary because the .NET client profile does
    /// not include System.Web.
    /// </remarks>
    public sealed class HttpUtils
    {
        ...
        /// <summary>
        /// See System.Web.HttpUtility API doc.
        /// </summary>
